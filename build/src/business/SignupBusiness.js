...
var SignupBusiness = /** @class */ (function () {
    function SignupBusiness(userDatabase, idGenerator, hashManager, authenticator) {
        this.userDatabase = userDatabase;
        this.idGenerator = idGenerator;
        this.hashManager = hashManager;
        this.authenticator = authenticator;
    }
    SignupBusiness.prototype.execute = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var id, hashPassword, user, accessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.hashManager.hash(input.password)];
                    case 1:
                        hashPassword = _a.sent();
                        user = User_1.User.toUserModel(__assign(__assign({}, input), { id: id, password: hashPassword }));
                        return [4 /*yield*/, this.userDatabase.createUser(user)];
                    case 2:
                        _a.sent();
