...
var UserDatabase = /** @class */ (function (_super) {
    ...
    UserDatabase.prototype.createUser = function (user) {
    ...
    UserDatabase.prototype.getUserByEmailOrNickname = function (emailOrNickname) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!result[0])
                            return [2 /*return*/];
                        return [2 /*return*/, User_1.User.toUserModel(result[0])];
                    case 2:
                        error_2 = _a.sent();
    ...
    UserDatabase.TABLE_NAME = "user_labesound";
    return UserDatabase;
